...
export default function Projet() {
  return (
    <div className='w-full space-y-8 '>
      <h1 className='text-center font-bold text-4xl text-black'>Projets</h1>
      ...
      <div className='flex gap-x-10 items-center justify-center'>
        ...
        <div className="card bg-base-100 w-96 shadow-lg">
          ...
          <div className="card-body">
            <h2 className="card-title font-bold">Rec'feo <span className='font-semibold text-gray-700'><p>(MERN, Python)</p></span></h2>
        ...
        <div className="card bg-base-100 w-96 shadow-lg">
          ...
          <div className="card-body">
            <h2 className="card-title font-bold">Spotshare <span className='font-semibold text-gray-700'><p>(MEVN)</p></span></h2>
        ...
        <div className="card bg-base-100 w-96 shadow-lg">
          ...
          <div className="card-body">
            <h2 className="card-title font-bold">Nala <span className='font-semibold text-gray-700'><p>(C#, Unity)</p></span></h2>
