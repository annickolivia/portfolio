    ...
    <nav className='backdrop-sepia-0 bg-[#DB0155]/5 fixed w-full z-10 p-5 ' >
      <div className=' w-full text-gray-700 flex items-center justify-around text-xl '>
          ...
          <ul className='flex gap-x-10'>
            <li className='hover:text-[#FF00D0]'>
              <a  href='/'>Accueil</a>
            </li>
            ...
            <li className='hover:text-[#FF00D0]'><a href='#outils'>Outils</a></li>
            <li className='hover:text-[#FF00D0]'><a href='#projet'>Projet</a></li>
            <li className='hover:text-[#FF00D0]'><a href='#contact'>Contact</a></li>
          </ul>
      </div>
